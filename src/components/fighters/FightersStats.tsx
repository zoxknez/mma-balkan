...
interface FightersStatsProps {
  filteredCount: number;
}

export const FightersStats = ({ filteredCount }: FightersStatsProps) => {
  const stats = [ 
    { icon: <Users className="w-8 h-8" />, value: filteredCount, label: "Aktivnih boraca", color: "#ef4444" },
