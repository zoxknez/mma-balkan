...
const HolographicDisplayLocal = memo(function Holo({ name, wins, losses, className }: Props) {
  return (
    <div className={`relative w-32 h-32 md:w-40 md:h-40 mx-auto ${className ?? ''}`}>
      {/* bazni prsten + “disanje” */}
...
export default HolographicDisplayLocal;
